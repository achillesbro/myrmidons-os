  ...
  return (
    <div className="space-y-4">
      <div className="space-y-2">
        ...
        <div className="space-y-1 text-sm font-mono text-text/80">
          <p>
            <GlitchTypeText key="mnemon-desc1" loading={!revealEnabled || loadingStates[3]} value="Every Morpho market on eight chains, sampled from the MNEMON archive: supply and borrow APY, liquidity, borrower risk, and a broken-market classifier." mode="text" />
          </p>
          <p>
