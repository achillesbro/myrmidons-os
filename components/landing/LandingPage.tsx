...
const SYSTEM_ROWS: {
  ...
  {
    name: "SCOPE",
    detail: "HYPEREVM (999) · ROBINHOOD (4663) · ARBITRUM (42161) · KATANA (747474) · MONAD (143) · ETHEREUM (1) · BASE (8453) · MORPHO MARKETS ONLY",
    chip: "POC",
      ...
      <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-8">
        <div>
          ...
          <p className="font-mono text-sm text-text/80 leading-relaxed max-w-xl mb-6">
            <RevealText
              delayMs={400}
              value="Data pipeline, strategy engine, contract integration and this interface, built and operated by one person. Questions, or a look under the hood:"
            />
          </p>
          <div className="flex flex-wrap gap-3">
